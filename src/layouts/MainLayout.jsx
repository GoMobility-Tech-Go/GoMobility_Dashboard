...
//         minHeight: "100vh",
//         background:
//           "linear-gradient(135deg,#020B22 0%,#041030 30%,#061540 60%,#041030 85%,#020B22 100%)",
...
//           zIndex: 0,
//           backgroundImage:
//             "linear-gradient(rgba(212,175,55,0.022) 1px,transparent 1px),linear-gradient(90deg,rgba(212,175,55,0.022) 1px,transparent 1px)",
...
//           borderRadius: "50%",
//           background:
//             "radial-gradient(circle,rgba(65,105,225,0.14) 0%,transparent 65%)",
//           pointerEvents: "none",
//           zIndex: 0,
//         }}
//       />
...
//         SIDEBAR_FULL={SIDEBAR_FULL}
//         SIDEBAR_COLLAPSED={SIDEBAR_COLLAPSED}
//       />

//       {/* ── MAIN CONTENT — shifts with sidebar, no overlap ── */}
//       <main
//         style={{
...
//           zIndex: 1,
//         }}
//         // on mobile sidebar sits above content (overlay), so no margin shift
...
//           }}
//           className="px-4 py-5 lg:px-8 lg:py-7"
//         >
//           <Outlet />
//         </div>
//       </main>
