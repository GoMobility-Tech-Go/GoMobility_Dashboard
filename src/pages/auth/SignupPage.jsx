...
/* ─── Particle canvas (same as LoginPage) ─── */
...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await registerAdmin({ full_name: fullName.trim(), phone_number: phone.trim(), role });
      setSuccess(true);
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .su-card { position:relative; z-index:2; width:100%; max-width:980px; height:min(580px,calc(100vh - 40px)); display:flex; border-radius:28px; overflow:hidden; box-shadow:0 0 0 1px rgba(212,175,55,0.18),0 40px 120px rgba(0,0,8,0.7),0 0 80px rgba(10,30,100,0.5),inset 0 1px 0 rgba(212,175,55,0.12); margin:0 16px; }
          ...
          <div className="su-left">
            ...
            <div style={{ position:"relative", zIndex:1, flex:1, display:"flex", flexDirection:"column", justifyContent:"center", padding:"24px 0" }}>
              ...
              <p style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:15, fontStyle:"italic", color:"rgba(255,255,255,0.6)", lineHeight:1.8, marginTop:16, maxWidth:280 }}>
                Register with your phone number. After signup, login using OTP to access your admin dashboard.
              </p>
            ...
            <div style={{ position:"relative", zIndex:1, background:"rgba(255,255,255,0.04)", border:"1px solid rgba(212,175,55,0.2)", borderRadius:16, padding:"16px 18px", backdropFilter:"blur(6px)" }}>
              ...
              <div style={{ fontSize:11.5, color:"rgba(255,255,255,0.65)", fontFamily:"'Outfit',sans-serif", fontWeight:300, lineHeight:1.6 }}>
                No password needed. After registration, sign in with your phone number — an OTP will be sent via SMS.
              </div>
            </div>
          </div>
            ...
            <div style={{ width:"100%", maxWidth:360 }}>
              ...
              {success ? (
                ...
                <form onSubmit={handleSubmit} style={{ display:"flex", flexDirection:"column", gap:14 }}>
                  ...
                  {/* Role */}
                  <div>
                    <label className="su-field-label">Role</label>
                    <div style={{ position:"relative" }}>
                      ...
                      <div style={{ position:"absolute", right:14, top:"50%", transform:"translateY(-50%)", pointerEvents:"none", color:"#9a8a6a" }}>
                  ...
                  <button type="submit" className="su-btn" disabled={loading}>
                    {loading
                      ...
                      : <span style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}><UserPlus size={14} /> Create Account</span>
                    }
                  </button>
                </form>
              )}
